...
label cap3normal_freya:
    ...
    a "Si, tienes razón... Creo que es por que nos has... ayudado a salir."

    show freya caderassonrisa with dissolve

    fr "Claro, soy responsable de todos ustedes y me aseguraré de que no mueran."

    "Sip, definitivamente estaba orgullosa de sí misma."

    a "Agradezco mucho no estar solo en esta situación..."
